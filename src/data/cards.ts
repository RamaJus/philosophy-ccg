...
export const cardDatabase: Card[] = [
    ...
    },
    {
        ...
        type: 'Zauber',
        cost: 1,
        description: 'Betrachte die obersten 3 Karten deines Decks, nimm 1 auf die Hand. Die anderen werden zurückgemischt.',
        rarity: 'Gewöhnlich',
        school: ['Metaphysik'],
    },
    {
        ...
        type: 'Zauber',
        cost: 0,
        description: 'Erhalte 1 zusätzliche Dialektik in diesem Zug.',
        rarity: 'Gewöhnlich',
        school: ['Logik'],
    },
    {
        ...
        attack: 2,
        health: 1,
        description: 'Der Kyniker. Kann erst angegriffen werden, wenn er 3 Runden auf dem Feld liegt.',
        rarity: 'Selten',
        school: ['Kynismus'],
    },
    {
