...
export const TutorialModal: React.FC<TutorialModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-2 border-emerald-700/50 rounded-xl w-full max-w-4xl shadow-2xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
                {/* Header */}
                ...
                <div className="p-6 space-y-8 overflow-y-auto custom-scrollbar flex-1 text-slate-300 leading-relaxed">
                    ...
                    <div className="text-center space-y-2 pb-2 border-b border-slate-700/50">
                        ...
                        <p className="text-lg text-amber-200/80 italic">
                            Hier kämpfst du nicht mit Schwertern, sondern nur mit Argumenten.
                        </p>
                        <p className="text-base text-slate-400">
                            Dein Ziel: Vernichte die Glaubwürdigkeit (Lebenspunkte) deines Gegners, bevor er deine Argumente zerpflückt.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-slate-800/40 p-4 rounded-lg border border-indigo-500/20 hover:border-indigo-500/40 transition-colors">
                            ...
                            <p className="text-sm">
                                Ohne Verständnis keine Macht. Jede Runde wächst dein Verständnis der Dialektik. Nutze es, um die größten Denker der Geschichte auf deine Seite zu beschwören.
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-800/40 p-4 rounded-lg border border-amber-500/20 hover:border-amber-500/40 transition-colors">
                            ...
                            <p className="text-sm">
                                Deine Denker debattieren für dich an vorderster Front. Jeder gehört einer oder mehrerer Schulen an.
                                <br />
                                <span className="text-slate-400 mt-1 block">– <strong>Synergien:</strong> Kombiniere Philosophen derselben Schule, um ihre Angriffe noch vernichtender zu machen!</span>
                                <span className="text-slate-400 block">– <strong>Angriff:</strong> Schicke sie los, um gegnerische Philosophen zu attackieren oder greife den Gegner direkt an.</span>
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-800/40 p-4 rounded-lg border border-purple-500/20 hover:border-purple-500/40 transition-colors">
                            ...
                            <p className="text-sm space-y-1">
                                <span className="block"><strong className="text-purple-200">Werke:</strong> Monumentale Schriften. Sie bleiben liegen und sorgen dauerhaft für größere rhetorische Standhaftigkeit.</span>
                                <span className="block"><strong className="text-fuchsia-200">Zauber:</strong> Ein Geistesblitz! Einmaliger Effekt, der dir helfen oder dem Gegner schaden kann.</span>
                            </p>
                        </div>
                        ...
                        <div className="bg-slate-800/40 p-4 rounded-lg border border-red-500/20 hover:border-red-500/40 transition-colors">
                            ...
                            <p className="text-sm">
                                Mächtige Geister wie <strong>Nietzsche</strong> oder <strong>Sokrates</strong> haben machtvolle Fähigkeiten, die jederzeit das Blatt wenden können.
                                <br />
                                <span className="flex items-center gap-2 mt-2 bg-slate-900/60 p-2 rounded border border-slate-700">
                                    <span className="text-blue-100">Ein Rechtsklick auf die Karte öffnet das Tooltip.</span>
                                </span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-emerald-900/10 border border-emerald-500/30 p-4 rounded-lg">
                        <h4 className="text-emerald-400 font-bold mb-2 uppercase text-xs tracking-wider">Strategie-Tipps</h4>
                        <ul className="text-sm space-y-2 list-disc list-inside text-slate-300">
                            <li><strong className="text-emerald-200">Vergiss nicht, den Zug zu beenden!</strong></li>
                            <li>Unterschätze niemals die Macht von Synergien.</li>
                            <li>Achte darauf, deine Dialektik effizient zu nutzen.</li>
                        </ul>
                    </div>
